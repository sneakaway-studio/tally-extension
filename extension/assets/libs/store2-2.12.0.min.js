...
//# sourceMappingURL=store2-2.12.0.min.js.map

/*
These were in store2-2.12.0.min.js.map, I moved them because JSON does not support comments.
Return these if they were being used:
// 20200916173140
// https://raw.githubusercontent.com/nbubna/store/master/dist/store2.min.js.map
For some reason Chrome says "DevTools failed to load SourceMap" with a 404. Chrome said this before and after my fixes.
However, this fixes a source map JSON parsing error in Firefox.

Store2 has little utility to the end user (as far as I can tell) so I'm not troubleshooting this issue any further for now.
*/