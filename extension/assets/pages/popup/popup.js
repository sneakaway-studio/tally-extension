...
$('#soundVolume').on('change', function() {
	...
	var audio = new Audio(browser.runtime.getURL("assets/sounds/tally/moods-v3/excited-2-1.wav"));
...
function updateSkins() {
	try {
		...
		for (var key in _tally_user.skins) {
			...
			str += "<img src='";
			str += browser.runtime.getURL('assets/img/tally/skins/skin-' + _tally_user.skins[key] + ".png");
			str += "'></a></span>";
		}
		$("#skinThumbs").html(str);
	} catch (err) {
