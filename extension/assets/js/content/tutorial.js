	...
	function slideshowCallback(callback = null) {
		try {
			 ...
			 ******************************************************************************/
				...
				frameStr = '<img src="' + browser.runtime.getURL('assets/img/tutorial/funniest-cat-gifs-cat-sit-right-here.gif') + '">';
			} else if (callback === "slideShowKindleMonster") {
				frameStr = '<img src="' + browser.runtime.getURL('assets/img/tutorial/monster-amazon-kindle.gif') + '">';
			} else if (callback === "slideShowPopUpAds") {
				frameStr = '<img src="' + browser.runtime.getURL('assets/img/tutorial/popup-ads.gif') + '">';
				...
				frameStr = '<img src="' + browser.runtime.getURL('assets/img/tutorial/monster-battle.gif') + '">';
			}
