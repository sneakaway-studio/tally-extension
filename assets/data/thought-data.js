...
var ThoughtData = (function() {
	...
	var data =
{"monster":{"far":[{"text":"I've got a bad feeling about this.","mood":"cautious"},{"text":"Be prepared for product monsters.","mood":"cautious"},{"text":"Something feels off here","mood":"cautious"},{"text":"Did you see that?","mood":"cautious"}],"close":[{"text":"There are monsters nearby ...","mood":"cautious"},{"text":"I think a product monster is getting closer ...","mood":"cautious"},{"text":"I think I saw a product monster ...","mood":"cautious"},{"text":"Be ready to click, a product monster is close by","mood":"cautious"},{"text":"Get ready, a product monster is nearby","mood":"cautious"}],"launch":[{"text":"A product monster!!!","mood":"danger"},{"text":"Look out, a {{type}} monster!!!","mood":"danger"},{"text":"Look out!!!","mood":"danger"},{"text":"Quick, don't let it escape!","mood":"danger"},{"text":"Click the product monster now!","mood":"danger"}],"captured":[{"text":"You just captured a product monster!","mood":"award"},{"text":"Wow, a {{type}} monster!","mood":"award"},{"text":"Good clicking, you captured it!","mood":"award"},{"text":"Woohoo, a {{type}} monster!","mood":"award"},{"text":"Great job, you got it!","mood":"award"}],"missed/ignored":[{"text":"The product monster got away","mood":"neutral"},{"text":"That one was fast, we have to be quicker!","mood":"neutral"},{"text":"Keep practicing, they can't run forever...","mood":"neutral"},{"text":"Almost had it!","mood":"neutral"},{"text":"We'll get it next time!","mood":"neutral"}]},"page":{"title":[{"text":"The title of this page is *****","mood":"neutral"}]},"player":{"complement":[{"text":"Nice clicking!","mood":"happy"}]},"random":{"greeting":[{"text":"Hello, I missed you.","mood":"sad"},{"text":"How are you?","mood":"question"},{"text":"Hello world! 😀","mood":"happy"}]},"tracker":{"lots":[{"text":"There are a lot of trackers on this page.","mood":"cautious"},{"text":"Careful, there are trackers nearby.","mood":"cautious"},{"text":"Seriously, it's getting kind of creepy around here.","mood":"cautious"}],"few":[{"text":"There are only a few trackers on this page.","mood":"cautious"}],"none":[{"text":"There are no trackers on this page.","mood":"happy"}]},"narrative":{"story1":{"text":"Finally! I’ve found you, __(insert username/some kind of identity)_______I need your help.","mood":"happy"},"story2":{"text":"My name is Tally.","mood":"neutral"},"story3":{"text":"I’m a daidite. You’ve probably never heard of me and my friends, but we live inside your computer in our world, Daedom.","mood":"neutral"},"story4":{"text":"We live, work, and play inside your computer to keep you connected to [insert #1 used website], your most used website. We process your data by moving and storing it.","mood":"neutral"},"story5":{"text":"But recently, one of the daidites, Vilikon, has been acting strangely…","mood":"cautious"},"story6":{"text":"Vilikon used to work inside your computer like the rest of us, but a few days ago he realized that he could absorb your data for himself. Just over the past few days, Vilikon’s power has already doubled.","mood":"cautious"},"story7":{"text":"Most recently, he created an army of data trackers called Product Monsters.","mood":"danger"},"story8":{"text":"While you’ve been browsing on your computer, Product Monsters have been watching you and taking your information.","mood":"cautious"},"story9":{"text":"This is what they already know about you: [list: browser, operating system, kind of computer, geographical location]","mood":"neutral"},"story10":{"text":"Help me stop Vilikon by taking your data back from him!","mood":"danger"},"story11":{"text":"Luckily you have me! I will stay right here and tell you when Product Monsters are nearby. As a Daidite, I can sense when trackers and other algorithmic influencers are lurking. ","mood":"happy"},"story12":{"text":"In fact, there's one right now!","mood":"cautious"},"story13":{"text":"Quick! Click on the Product Monster to capture it!","mood":"danger"},"story14":{"text":"Good job! You've captured your first product monster. As you use the internet, Product Monsters living on webpages will appear. For example, if you are looking at a dessert recipe, this Cake Product Monster may pop up because of the site's meta tag 'recipe'.","mood":"award"},"story15":{"text":"As you collect new Product Monsters, they will appear here. You can level up each Product Monster in your collection by catching more of the same type! ","mood":"happy"},"story16":{"text":"The more monsters you collect, the more points you gain and the higher your rank will be in the leaderboards.","mood":"happy"},"story17":{"text":"Be careful when trying to capture Product Monsters. If your click misses the product monster, your score will drop.","mood":"cautious"},"story18":{"text":"Try to get to the #1 spot on a leaderboard! I've only heard rumors, but something really cool happens if you get the top spot.","mood":"happy"},"story19":{"text":"*Thunder rumble sound effect*","mood":"specialized sound effect"},"story20":{"text":"Oh no! Vilikon just got even stronger.","mood":"danger"},"story21":{"text":"Before you start your journey to defeat Vilikon, we need to create your secret identity. Let's go to your profile page!","mood":"happy"}}};
...
{ google:
  ...
  facebook:
   [ { domain: 'facebook',
     ...
     { domain: 'facebook',
       ...
       url: 'https://cliqz.com/en/magazine/cambridge-analytica-scandal-delete-facebook-account' },
     { domain: 'facebook',
       fact: 'In a 2018 interview, Mark Zuckerberg says that Facebook won’t be able to uncover where all of its user data ended up and how it is being deployed',
  ...
  trackers:
   [ { domain: 'trackers',
     ...
     { domain: 'trackers',
       fact: '77.4% of all page loads contain trackers',
